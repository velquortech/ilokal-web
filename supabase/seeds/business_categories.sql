...
DECLARE
    ...
    tourism_id UUID;
BEGIN
    -- 1. Insert Business Types and capture IDs
    ...
    -- 2. Insert Categories for Food & Beverage
    ...
    -- 3. Insert Categories for Retail
    INSERT INTO business_categories (business_type_id, name, description, image_url) VALUES
    ...
    -- 4. Insert Categories for Services
    INSERT INTO business_categories (business_type_id, name, description, image_url) VALUES
    ...
    -- 5. Insert Categories for Tourism & Leisure
    INSERT INTO business_categories (business_type_id, name, description, image_url) VALUES
