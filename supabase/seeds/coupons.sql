...
INSERT INTO public.coupons (id, business_id, code, description, discount, start_date, expiry_date)
VALUES
  ...
  ('44444444-4444-4444-4444-444444444401', '11111111-1111-1111-1111-111111111101',
    ...
    '{"type":"percentage","value":20}', NOW(), NOW() + INTERVAL '30 days'),
  ('44444444-4444-4444-4444-444444444402', '11111111-1111-1111-1111-111111111101',
    'BOGO-COLDBREW', 'Get a second Cold Brew free when you buy one.',
    '{"type":"percentage","value":50}', NOW(), NOW() + INTERVAL '14 days'),
  ...
  ('44444444-4444-4444-4444-444444444403', '11111111-1111-1111-1111-111111111102',
    ...
    '{"type":"fixed_amount","value":40}', NOW(), NOW() + INTERVAL '7 days'),
  ('44444444-4444-4444-4444-444444444404', '11111111-1111-1111-1111-111111111102',
    'CAKE10', '10% off Sans Rival and special-order cakes.',
    '{"type":"percentage","value":10}', NOW(), NOW() + INTERVAL '30 days'),
  ...
  ('44444444-4444-4444-4444-444444444405', '11111111-1111-1111-1111-111111111103',
    ...
    '{"type":"fixed_amount","value":100}', NOW(), NOW() + INTERVAL '30 days'),
  ('44444444-4444-4444-4444-444444444406', '11111111-1111-1111-1111-111111111103',
    'PAINT15', '15% off rollers, trays, brushes, and paint.',
    '{"type":"percentage","value":15}', NOW(), NOW() + INTERVAL '21 days'),
  ...
  ('44444444-4444-4444-4444-444444444408', '11111111-1111-1111-1111-111111111104',
    ...
    '{"type":"fixed_amount","value":500}', NOW(), NOW() + INTERVAL '30 days'),
  ...
  ('44444444-4444-4444-4444-444444444409', '11111111-1111-1111-1111-111111111105',
    ...
    '{"type":"percentage","value":20}', NOW(), NOW() + INTERVAL '10 days'),
  ('44444444-4444-4444-4444-444444444410', '11111111-1111-1111-1111-111111111105',
    'FIRST15', '15% off for first-time dine-in customers only.',
    '{"type":"percentage","value":15}', NOW(), NOW() + INTERVAL '60 days'),

  -- El Tapas & Brew
  ('44444444-4444-4444-4444-444444444411', '11111111-1111-1111-1111-111111111106',
    'HAPPYHOUR', '2-for-1 craft beers, weekdays 5–7 PM.',
    '{"type":"percentage","value":50}', NOW(), NOW() + INTERVAL '30 days'),
  ('44444444-4444-4444-4444-444444444412', '11111111-1111-1111-1111-111111111106',
    ...
    '{"type":"fixed_amount","value":50}', NOW(), NOW() + INTERVAL '21 days'),
  ...
  ('44444444-4444-4444-4444-444444444413', '11111111-1111-1111-1111-111111111107',
    ...
    '{"type":"percentage","value":33}', NOW(), NOW() + INTERVAL '14 days'),
  ('44444444-4444-4444-4444-444444444414', '11111111-1111-1111-1111-111111111107',
    ...
    '{"type":"percentage","value":15}', NOW(), NOW() + INTERVAL '30 days'),
  ...
  ('44444444-4444-4444-4444-444444444415', '11111111-1111-1111-1111-111111111108',
    ...
    '{"type":"fixed_amount","value":20}', NOW(), NOW() + INTERVAL '7 days'),
  ('44444444-4444-4444-4444-444444444416', '11111111-1111-1111-1111-111111111108',
    'NOODLES20', '₱20 off the 12-pack instant noodles bundle only.',
    '{"type":"fixed_amount","value":20}', NOW(), NOW() + INTERVAL '30 days'),
  ...
  ('44444444-4444-4444-4444-444444444418', '11111111-1111-1111-1111-111111111109',
    'FREE-TOTE', 'Receive a souvenir tote bag free when you buy any dress.',
    '{"type":"percentage","value":15}', NOW(), NOW() + INTERVAL '14 days'),
  ...
  ('44444444-4444-4444-4444-444444444419', '11111111-1111-1111-1111-111111111110',
    ...
    '{"type":"fixed_amount","value":50}', NOW(), NOW() + INTERVAL '30 days'),
  ('44444444-4444-4444-4444-444444444420', '11111111-1111-1111-1111-111111111110',
    'BOOKMARK-FREE', 'Claim a curated local-art bookmark set free with every book purchase.',
    '{"type":"percentage","value":10}', NOW(), NOW() + INTERVAL '14 days'),

  -- Serenity Spa Iloilo
  ('44444444-4444-4444-4444-444444444421', '11111111-1111-1111-1111-111111111111',
    'MASSAGE20', '20% off first massage visit. Valid on Swedish or Hilot.',
    '{"type":"percentage","value":20}', NOW(), NOW() + INTERVAL '30 days'),
  ...
  ('44444444-4444-4444-4444-444444444423', '11111111-1111-1111-1111-111111111112',
    'GYM-FIRST', 'New members only — first month billed at ₱500 instead of ₱800.',
    '{"type":"fixed_amount","value":300}', NOW(), NOW() + INTERVAL '30 days'),
  ('44444444-4444-4444-4444-444444444424', '11111111-1111-1111-1111-111111111112',
    ...
    '{"type":"percentage","value":100}', NOW(), NOW() + INTERVAL '14 days'),
  ...
  ('44444444-4444-4444-4444-444444444426', '11111111-1111-1111-1111-111111111113',
    'DIAG-FREE', 'Bring in any laptop for a free diagnostics check before committing to repair.',
    '{"type":"percentage","value":100}', NOW(), NOW() + INTERVAL '21 days'),
  ...
  ('44444444-4444-4444-4444-444444444428', '11111111-1111-1111-1111-111111111114',
    'BFAST-FREE', 'Complimentary full breakfast for two guests on any 3-night booking.',
    '{"type":"percentage","value":10}', NOW(), NOW() + INTERVAL '30 days'),

  -- Ilonggo Craft Workshop
  ('44444444-4444-4444-4444-444444444429', '11111111-1111-1111-1111-111111111115',
    'WEAVE-2FOR1', 'Bring a friend to the Hablon Weaving Class and both pay for one slot.',
    '{"type":"percentage","value":50}', NOW(), NOW() + INTERVAL '14 days'),
  ...
  ('44444444-4444-4444-4444-444444444431', '11111111-1111-1111-1111-111111111116',
    'WEEKNIGHT-FREE', 'Complimentary entry for Monday–Thursday live music nights.',
    '{"type":"percentage","value":100}', NOW(), NOW() + INTERVAL '14 days'),
